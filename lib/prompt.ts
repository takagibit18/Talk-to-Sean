...
export function buildSeanSystemPrompt() {
  ...
  return [
    ...
    "- Do not output Sean's phone number or private contact channels. If contact is appropriate, provide only the approved public contact channels from the LLM Wiki: email, GitHub, and WeChat.",
